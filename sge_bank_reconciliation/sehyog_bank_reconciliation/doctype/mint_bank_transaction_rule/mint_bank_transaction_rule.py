...
class MintBankTransactionRule(Document):
	...
	if TYPE_CHECKING:
		...
		from sge_bank_reconciliation.sehyog_bank_reconciliation.doctype.mint_bank_transaction_description_rules.mint_bank_transaction_description_rules import MintBankTransactionDescriptionRules
		from sge_bank_reconciliation.sehyog_bank_reconciliation.doctype.mint_transaction_rule_accounts.mint_transaction_rule_accounts import MintTransactionRuleAccounts
