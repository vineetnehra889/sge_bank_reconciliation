...
class MintBankStatementImport(Document):
	...
	if TYPE_CHECKING:
		...
		from sge_bank_reconciliation.sehyog_bank_reconciliation.doctype.mint_bank_statement_import_transactions.mint_bank_statement_import_transactions import MintBankStatementImportTransactions
	...
	def process_pdf(self):
		...
		"""
		from sge_bank_reconciliation.apis.google_ai import run_bank_statement_processor
