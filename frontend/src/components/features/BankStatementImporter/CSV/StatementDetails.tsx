...
const StatementDetails = ({ data, bank, onBack }: Props) => {
    ...
    const { call, loading, error } = useFrappePostCall<{ message: { success: boolean, start_date: string, end_date: string } }>('sge_bank_reconciliation.apis.statement_import.import_statement')
    ...
    useFrappeEventListener("sge-bank-reco-statement-import-progress", (event) => {
