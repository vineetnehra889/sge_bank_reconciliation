...
export const bankRecDateAtom = atomWithStorage<{ fromDate: string, toDate: string }>("sge-bank-reco-date", {
...
export const bankRecMatchFilters = atomWithStorage<string[]>('sge-bank-reco-match-filters', ['payment_entry', 'journal_entry'])
...
export const bankRecActionLog = atomWithStorage<ActionLog[]>('sge-bank-reco-action-log', [], actionLogStorage, {
    getOnInit: true,
})