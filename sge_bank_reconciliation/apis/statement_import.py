...
from sge_bank_reconciliation.apis.bank_account import set_closing_balance_as_per_statement
...
def import_statement(file_url: str, bank_account: str):
    ...
    for transaction in data.get("final_transactions"):
        ...
        frappe.publish_realtime("sge-bank-reco-statement-import-progress", {
    ...
    from sge_bank_reconciliation.apis.rules import run_rule_evaluation
    run_rule_evaluation()
