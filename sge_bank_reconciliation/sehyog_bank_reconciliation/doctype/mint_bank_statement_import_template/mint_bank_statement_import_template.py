...
class MintBankStatementImportTemplate(Document):
	...
	if TYPE_CHECKING:
		...
		from sge_bank_reconciliation.sehyog_bank_reconciliation.doctype.mint_bank_statement_import_template_columns.mint_bank_statement_import_template_columns import MintBankStatementImportTemplateColumns
